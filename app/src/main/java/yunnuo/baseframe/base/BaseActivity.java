...
import yunnuo.baseframe.utils.DialogHelper;
import yunnuo.baseframe.utils.StatusBarUtil;
import yunnuo.baseframe.utils.T;
import yunnuo.baseframe.widget.MultiStateView;
import yunnuo.baseframe.widget.SimpleMultiStateView;
...
public abstract class BaseActivity<T1 extends BaseContract.BasePresenter> extends SupportActivity implements IBase, BaseContract.BaseView, BGASwipeBackHelper.Delegate {
    ...
    protected void T(String string) {
        T.showShort(MyApp.getInstance(), string);
    }
